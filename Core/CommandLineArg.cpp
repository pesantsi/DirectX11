...
namespace CoreProject
{
    ...
    void CommandLineArgs::Initialize(int argc, wchar_t ** argv)
    {
    ...
    bool CommandLineArgs::GetInteger(const wchar_t* key, uint32_t& value)
    {
    ...
    bool CommandLineArgs::GetFloat(const wchar_t* key, float& value)
    {
        return Lookup(key, [&value](std::wstring& val)
        {
    ...
    bool CommandLineArgs::GetString(const wchar_t* key, std::wstring& value)
    {
        return Lookup(key, [&value](std::wstring& val)
        {
            value = val;
